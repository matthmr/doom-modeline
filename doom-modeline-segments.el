          ...
          (let-alist (doom-modeline--flymake-count-errors)
            (let ((seg (if doom-modeline-check-simple-format
                           (let ((count (+ .error .warning .note))
                             ...
                             (cond
                              (some-waiting (concat
                                             (doom-modeline-check-icon "*" 'doom-modeline-debug)
                                             (when (> count 0)
                                               (concat
                                                (doom-modeline-vspc)
